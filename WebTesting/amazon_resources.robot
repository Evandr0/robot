...
Acessar a home page do site Amazon.com.br
    Go To    url=${URL}
    Wait Until Page Contains Element    locator=${MENU_ELETRONICOS}
...
Verificar o resultado da pesquisa, se está listando o produto "${PRODUTO}"
    Wait Until Element Is Visible    locator=(//span[contains(.,'${PRODUTO}')])[2]    timeout=30
...
Quando pesquisar pelo produto "Xbox Series S"
    ...
    Clicar no botão de pesquisa
    Wait Until Page Contains Element    locator=//span[@class='a-size-base-plus a-color-base a-text-normal'][contains(.,'Console Xbox Series S')]
